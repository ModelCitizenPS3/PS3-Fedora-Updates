...
%description minilzo
A small (mini) version of lzo for embedding into applications which do not
need full blown lzo compression support.
...
gcc $BITS %{optflags} -shared -o libminilzo.so.0 -Wl,-soname,libminilzo.so.0 minilzo/minilzo.o
...
- Initial build for the Playstation 3 Cell/B.E. (sackboy)
